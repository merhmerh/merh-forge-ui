...
export { initItems } from "./components/select/Select.svelte";
...
export { dictionary, convert, convertStringToArray } from "./components/Waterfall/Waterfall.store.js";

export { notify } from "./components/Notify/notify.store.js";
